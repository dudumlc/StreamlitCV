...
projects.markdown('**<span style="color: #F44E3F;">Kruskal Wallis test</span>**', unsafe_allow_html=True)
projects.write('Relationship between the number of spectators at a football game and the result of the match')
projects.markdown('**<span style="color: #F44E3F;">Sales prediction</span>**', unsafe_allow_html=True)
